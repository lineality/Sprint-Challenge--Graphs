...
while rooms_visited_set != set_of_all_room_numbers:
    ...
    if this_direction not in player.current_room.get_exits():
        ...
        # try going left
            ...
            while player.current_room.id != crossroads_room_I_want:
                ...
                # print("player.current_room.id", player.current_room.id)
                # print("\n")
                # print("Moving in this direction:")
                ...
                # updates for only when you enter a new room
                ...
                step_counter += 1
                ### end of "travel to nearest unexplored crossroads" fork

            # then, in the new room: pick a new direction
            # to try to walk straight in for a while
    ...
    print("number of rooms", len(rooms_visited_set))
